...
%>
	...
	<%-- <c:forEach items="${products}" var="product"> --%>
	 <%   int i=1;
		...
		<div class="w3-third w3-container w3-margin-bottom">
			<img src="<%=url1 %>" alt="Norway" style="width: 100%" class="w3-hover-opacity">
	...
	<%-- <div class="w3-row-padding" style="padding:0px 30px; margin-bottom: 20px">
		...
		<div class="w3-third w3-container w3-margin-bottom">
			<img src="<c:url value="/assets/images/products/1.jpg"/>" alt="Norway" style="width: 100%"
				class="w3-hover-opacity">
			<div class="w3-container w3-white">
				<p>
					<b>Oppo A53</b>
		...
		<div class="w3-third w3-container w3-margin-bottom">
			<img src="<c:url value="/assets/images/products/4.jpg"/>" alt="Norway" style="width: 100%"
				class="w3-hover-opacity">
			<div class="w3-container w3-white">
				<p>
					<b>Oppo A37</b>
